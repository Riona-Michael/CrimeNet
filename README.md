# CrimeNet
A fast, cloud-powered crime reporting system built on Google Sheets and Apps Script. It captures incidents in real time, stores data securely, and enables quick, reliable access—making reporting simple, efficient, and actionable.
